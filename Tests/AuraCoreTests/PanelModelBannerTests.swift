...
struct PanelModelBannerTests {
    ...
    static func model(sessions: [SessionState], banner: PanelBanner?) -> PanelModel {
        PanelModel.make(icon: icon, sessions: sessions, palette: .default,
                        ...
                        launchAtLogin: nil, externalTargetPath: nil, banner: banner, systemReduceMotion: false, userReduceMotion: false, iconPlate: true, iconShape: .ledStrip, language: .traditionalChinese, codex: .unavailable, codexSnippet: nil)
    }
    ...
    func noCTAWhenAlreadyConnectedRegardlessOfBanner() {
        let model = PanelModel.make(icon: Self.icon, sessions: [], palette: .default,
                                    ...
                                    launchAtLogin: nil, externalTargetPath: nil, banner: .connected(language: .traditionalChinese), systemReduceMotion: false, userReduceMotion: false, iconPlate: true, iconShape: .ledStrip, language: .traditionalChinese, codex: .unavailable, codexSnippet: nil)
