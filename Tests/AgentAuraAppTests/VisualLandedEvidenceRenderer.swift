...
struct VisualLandedEvidenceRenderer {
    ...
    func stateAModel() -> PanelModel {
        ...
        return PanelModel.make(icon: icon, sessions: sessions, palette: .default,
                               ...
                               systemReduceMotion: false, userReduceMotion: false, iconPlate: true, iconShape: .ledStrip, language: .traditionalChinese, codex: .unavailable, codexSnippet: nil, now: now)
    }
