...
struct Phase2EvidenceRenderer {
    ...
    func renderRemainingA3ThroughA8Evidence() throws {
        ...
        let optionsExpanded = PanelModel.make(icon: .empty, sessions: [], palette: .default,
                                              ...
                                              optionsExpanded: true, launchAtLogin: false, externalTargetPath: nil, banner: nil, systemReduceMotion: false, userReduceMotion: false, iconPlate: true, language: .traditionalChinese)
        ...
        let bannerStillThere = PanelModel.make(icon: .empty, sessions: [], palette: .default,
                                               ...
                                               banner: .connected(language: .traditionalChinese), systemReduceMotion: false, userReduceMotion: false, iconPlate: true, language: .traditionalChinese)
    ...
    func renderA9A10Evidence() throws {
        ...
        let toggleOn = PanelModel.make(icon: .empty, sessions: [], palette: .default,
                                       install: .connected(owner: .thisApp, verified: .verified), version: "1.0",
                                       optionsExpanded: true, launchAtLogin: true, externalTargetPath: nil, banner: nil, systemReduceMotion: false, userReduceMotion: false, iconPlate: true, language: .traditionalChinese)
        ...
        let worstCase = PanelModel.make(icon: .empty, sessions: [], palette: .default,
                                        ...
                                        externalTargetPath: "/Users/dev/some/very/long/path/to/repo/plugin", banner: nil, systemReduceMotion: false, userReduceMotion: false, iconPlate: true, language: .traditionalChinese)
