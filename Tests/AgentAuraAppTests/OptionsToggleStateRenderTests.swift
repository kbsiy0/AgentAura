...
struct OptionsToggleStateRenderTests {
    ...
    func model(launchAtLogin: Bool) -> PanelModel {
        PanelModel.make(icon: .empty, sessions: [], palette: .default,
                        ...
                        optionsExpanded: true, launchAtLogin: launchAtLogin, externalTargetPath: nil, banner: nil, systemReduceMotion: false, userReduceMotion: false, iconPlate: true, iconShape: .ledStrip, language: .traditionalChinese, codex: .unavailable, codexSnippet: nil, codexPathRejection: nil)
    }
